...
class ProductController extends BaseController
{
    ...
    {
        //must delete product from product categories table first since it references the product id
        DB::table('product_categories')->where('product_id',$id)->delete();
        
        //$prodCatDB = DB::table('product_categories')->get();
        //DB::table('product_categories')->where('product_id','==',$id)->delete(); //cannot use == sign

        //$prodCatDB->where('product_id','==',$id)->delete(); //cannot use delete on collection
        //dd($prodCatDB);
